...
Before the commencement of study, a series of comprehensive Zoom trainings took place to familiarise research assistants with NZAVS, the MDS background, and survey questionnaires. In addition, research assistants learned about ethical guidelines, confidentiality principles, and interacting with a culturally diverse participants pool. **We also learned about how to plan for hiring participants and promoting the community participation in the study**
...
Research assistants used the snowball approach for data collection. They started reaching out to their close circles, and kept expanding their reach **In my experience, this was the most effective manner to get reliable responses from people, as compared to reaching out to organisations**. The sample was non-representative, and participants had the choice of filling in the online questionnaire using Qualtrics, or a paper questionnaire and returning it to the NZAVS headquarters in Auckland University using a pre-paid postal envelope.
...
For the purposes of community promotion, we relied on a combination of community outreach at local mosques, religious, community, and ethnic organisations, Muslim schools and businesses, and MSA’s (Muslim Student Associations). **Some of them were non- necessarily Muslim**. From available databases and community contacts, we identified `{r} total_organizations` organisations and RAs were able to approach Muslims in `{r} total_reached_out` organisations. Out of these, `{r} total_responded` have endorsed and promoted the study. Different organisations endorsed us in different manners: some allowed us to give speeches to their audience, others shared our promotional material online in social media, community message groups (e.g., WhatsApp), and mailing lists. In addition, tens of posters were placed in community facilities (e.g., mosques) and hundreds of flyers were handed over after Friday prayers as well as cultural and religious festivals. **in addition to these community centers and organisations other organisations such as the libraries, refugee settlement centers  and citizen advice Bureau (CAB) where approached to increase the reach to the community**
...
- This study is groundbreaking as it is among the few studies that, from a quantitative approach, solely focus on the representation of the Muslim community, which is a major strength. However, explaining its importance to the community took more time and effort than expected.

- - A limitation that slowed the study and reduced participant numbers was its design. As part of the NZAVS longitudinal research, the study aimed to maintain the same structure. While this allows for comparisons with the wider New Zealand society, it limited our ability to fully adapt the study to the cultural norms and values of the Muslim community.??? Not sure if this is correct..
...
\noindent For any queries regarding ethical concerns, you may contact the Chair, University of Auckland Human Participants Ethics Committee, Ethics and Integrity Team, University of Auckland, Private Bag 92019, Auckland 1142. Telephone 09 373-7599 ext. 83711. Email: <humanethics@auckland.ac.nz>.
...
::: {.callout}
If you would like to complete this questionnaire online instead of returning by post, please use: 
<https://www.nzavs.auckland.ac.nz/muslim_diversity>.
:::
